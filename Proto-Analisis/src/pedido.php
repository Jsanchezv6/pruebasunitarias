                ...
                <div class="col-7 col-sm-9">
                    <div class="tab-content" id="vert-tabs-right-tabContent">
                        <div class="tab-pane fade show active" id="vert-tabs-right-home" role="tabpanel" aria-labelledby="vert-tabs-right-home-tab">
                            <input type="hidden" id="id_sucursal" value="<?php echo htmlspecialchars($_GET['id_sucursal']); ?>">
                            <input type="hidden" id="caja" value="<?php echo htmlspecialchars($_GET['caja']); ?>">
                            <div class="row">
                                <?php
                                ...
                                if ($result > 0) {
                                    while ($data = mysqli_fetch_assoc($query)) { ?>
                                        <div class="col-md-3">
                                            <div class="col-12">
                                                <img src="<?php echo ($data['imagen'] == null) ? '../assets/img/default.png' : htmlspecialchars($data['imagen']); ?>" class="product-image" alt="Product Image">
                                            </div>
                                            <h6 class="my-3"><?php echo htmlspecialchars($data['nombre']); ?></h6>

                                            <div class="bg-gray py-2 px-3 mt-4">
                                                <h2 class="mb-0">
                                                    Q<?php echo htmlspecialchars($data['precio']); ?>
                                                </h2>
                                            </div>

                                            <div class="mt-4">
                                                <a class="btn btn-primary btn-block btn-flat addDetalle" href="#" data-id="<?php echo htmlspecialchars($data['id']); ?>">
                                                    <i class="fas fa-cart-plus mr-2"></i>
                                                    Agregar <?php echo htmlspecialchars($data['id']); ?>
                                                </a>
                                            </div>
                                        </div>
                                <?php }
